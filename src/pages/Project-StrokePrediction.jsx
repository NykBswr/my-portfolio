...
import Img2 from '../assets/StrokePred-2.png'
import Img3 from '../assets/StrokePred-3.png'
import Img4 from '../assets/StrokePred-4.png'
import Img5 from '../assets/StrokePred-5.png'
import Img6 from '../assets/StrokePred-6.png'
                    ...
                    <motion.div variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amout: 0.3 }} className='flex-1 lg:bg-bottom bg-no-repeat mix-blend-lighten mb-12 lg:mb-0'>
                        ...
                        {/* <div className='border-b border-dark/20 dark:border-white/20'>
                            ...
                            <p className='text-dark dark:text-white font-secondary leading-tight mb-5'>
                                In collaboration with my colleague, we developed a machine learning system using the Support Vector Machine algorithm to detect stroke
                                likelihood in patients. Achieving 81% accuracy, the trained model is integrated into an API program accessible through our website.
                                Medical professionals can input patient data via the API to receive stroke predictions, aiding in early detection and decision-making. This
                                project is my final project for Algorithm Programming 2, demonstrates our application of knowledge and skills in developing a practical
                                solution for improving patient care. The trained model, stored as a pickle file, seamlessly integrates into the API program. The system
                                serves as a valuable tool for medical professionals, providing prompt and appropriate medical attention by detecting strokes early on.
                            </p>
                    </motion.div>
                    </div>
                </div>
