...
const services = [
  {
    ...
    link: '/project-surat_menyurat_ftmm',
    learn: 'Learn more',
  },
  {
    ...
    link: '/project-sunrise_jeep_tour',
    learn: 'Learn more',
  },
  {
    ...
    link: '/project-stroke_prediction',
    learn: 'Learn more',
  },
];
          ...
          <motion.div variants={fadeIn('left', 0.5)} initial='hidden' whileInView={'show'} viewport={{ once: false, amout: 0.3 }} className='flex-1'>
            <div>
              {services.map((service, index) => {
                ...
                return (
                  <div className='border-b border-dark/20 dark:border-white/20 h-[147px] mb-[38px] flex' key={index}>
